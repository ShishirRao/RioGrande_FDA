...
ggsave("fish_response_variability_6_3_20.jpg", fish_response_plot, device = "jpg",
...
ggsave("flow_variability_6_3_20.jpg", flow_variability, device = "jpg",
       path = "F:/wild/PhD/ICON/Internship/RE__HEC-EFM_Results_for_FDA/",
       scale = 2, width = NA, height = NA, units = c("in", "cm", "mm"),
       dpi = 300, limitsize = TRUE)
...
ggsave("EFM_variability_6_3_20.jpg", EFM_variability, device = "jpg",
       path = "F:/wild/PhD/ICON/Internship/RE__HEC-EFM_Results_for_FDA/",
       scale = 2, width = NA, height = NA, units = c("in", "cm", "mm"),
       dpi = 300, limitsize = TRUE)
